...
3. Если вы не можете установить плагин, вы не сможете собрать новый `.exe`, но вы всё равно сможете запустить проект в режиме разработки через `npx vite` (если у вас есть готовый сервер).
